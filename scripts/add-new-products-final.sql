-- Add new jersey products to database (final working version)
-- First, let's check if we need to handle image column differently
...
-- Alternative approach if image column exists and has NOT NULL constraint
-- Tunisia Yellow Jersey (with default image)
