-- Add new jersey products to database (minimal working version)
-- Only use columns that we know exist and work: id, name, description, price, category, team, images, stock, sizes, created_at, updated_at
-- Skip the problematic 'image' column entirely
