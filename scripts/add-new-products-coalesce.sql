-- Add new jersey products to database (final version with COALESCE)
-- Tunisia Yellow Jersey
INSERT INTO products (id, name, description, price, category, team, images, stock, sizes, created_at, updated_at)
VALUES (
  gen_random_uuid(),
...
-- Alternative: If image column exists and has NOT NULL constraint, use COALESCE
-- This ensures we never insert NULL into the image column
...
VALUES (
  ...
  'national',
  'Tunisia',
  COALESCE('/jerseys/tunisia-yellow-front.jpeg', '/jerseys/tunisia-yellow-front.jpeg'),
  '{"front": "/jerseys/tunisia-yellow-front.jpeg", "back": "/jerseys/tunisia-yellow-back.jpeg"}',
  50,
  ARRAY['S', 'M', 'L', 'XXL']::text[],
  NOW(),
