-- Add new jersey products to database (final version with image defaults)
...
-- If image column has NOT NULL constraint, add default values
-- Tunisia Yellow Jersey (with image default)
